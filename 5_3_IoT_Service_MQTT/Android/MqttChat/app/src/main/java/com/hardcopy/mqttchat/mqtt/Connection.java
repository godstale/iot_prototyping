 ...
 */
package com.hardcopy.mqttchat.mqtt;
...
public class Connection {
  ...
  public void addAction(String action) {
    ...
    notifyListeners(new PropertyChangeEvent(this, Const.PROPERTY_HISTORY, null, null));
  }
  ...
  public void changeConnectionStatus(ConnectionStatus connectionStatus) {
    ...
    notifyListeners((new PropertyChangeEvent(this, Const.PROPERTY_CONNECTION_STATUS, null, null)));
  }
  ...
  public String toString() {
    ...
    switch (status) {
      ...
      case CONNECTED :
        sb.append(context.getString(R.string.connected_to));
        break;
      case DISCONNECTED :
        sb.append(context.getString(R.string.disconnected_from));
        break;
      case NONE :
      ...
      case DISCONNECTING :
        ...
        break;
      case ERROR :
        sb.append(context.getString(R.string.connection_error));
    }
    sb.append(" ");
    sb.append(host);
